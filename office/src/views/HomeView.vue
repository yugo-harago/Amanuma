                    ...
                    <div class="fw-bold">
                      <div class="text-truncate">
                        <span
                          ...
                          the progress so far, keep up the good work!</span
                        >
                      </div>
                ...
                <div class="row align-items-center">
                  <div class="col-auto">
                    <svg
                      ...
                      fill="currentColor"
                      viewBox="0 0 16 16"
                      class="bi bi-file-text fa-2x text-gray-300"
                    >
                      <path
                ...
                <div class="row align-items-center">
                  <div class="col-auto">
                    <svg
                      ...
                      class="icon icon-tabler icon-tabler-building-church fa-2x text-gray-300"
                    >
                ...
                <div class="row align-items-center">
                  <div class="col-auto">
                    <svg
                      ...
                      fill="currentColor"
                      viewBox="0 0 16 16"
                      class="bi bi-link-45deg fa-2x text-gray-300"
                    >
                      <path
            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body" style="padding-bottom: 0">
                <div class="row">
                  <div class="col">
                    <div
                      class="card text-bg-secondary border-start-primary py-2"
                    ...
                    <div
                      class="card text-bg-secondary border-start-primary py-2"
                      style="margin-bottom: var(--bs-card-spacer-x)"
                    >
                      <div class="card-body">
                        <div class="row align-items-center">
                          <div class="col">
